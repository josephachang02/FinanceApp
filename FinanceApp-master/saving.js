...
let NoSavingsLowIncomeTight = (LowIncomeTight || MidLowIncomeTight);
let SpenderNNoLowSaving = (LowIncomeHighSpender || LowIncomeHighN || LowIncomeHighSpenderMidSavings || LowIncomeHighNMidSavings || MidLowIncomeHighSpender || MidLowIncomeHighN || MidLowIncomeHighSpenderMidSavings || MidLowIncomeHighNMidSavings)
let HighSavingsLowIncomeTight = (MidLowIncomeHighSavingsTight || LowIncomeHighSavingsTight);
let SpenderNHighSaving = (LowIncomeHighNHighSavings || LowIncomeHighSpenderHighSavings || MidLowIncomeHighNHighSavings || MidLowIncomeHighSpenderHighSavings);
let TightMidSavingLowIncome = (MidLowIncomeMidSavingsTight || LowIncomeMidSavingsTight);

//High Mid High Income Meme 
let NoSavingsHighIncomeTight = (HighMidIncomeTight || HighIncomeTight);
let SpenderNNoLowSavingsHigh = (HighMidIncomeHighSpender || HighMidIncomeHighN || HighMidIncomeHighSpenderMidSavings || HighMidIncomeHighNMidSavings || HighIncomeHighSpender || HighIncomeHighN || HighIncomeHighSpenderMidSavings || HighIncomeHighNMidSavings); 
let HighSavingsHighIncomeTight = (HighMidIncomeHighSavingsTight || HighIncomeHighSavingsTight);
let TightMidSavingHighIncome = (HighMidIncomeMidSavingsTight || HighIncomeMidSavingsTight);
let HighIncomeSpenderNHighSavings = (HighMidIncomeHighNHighSavings || HighMidIncomeHighSpenderHighSavings || HighIncomeHighNHighSavings || HighIncomeHighSpenderHighSavings );

const myImage = document.getElementById("myImage");

// Set the new src attribute value
myImage.src = "./IMG-5563.PNG";

RevealFinanceBtn.addEventListener("click", ()=> {
    let Meme ='';
