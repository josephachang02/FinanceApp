...
const expenses = urlParams.get('MonthlyExpenses');
...
const totalField = document.getElementById('PersonalTotal');
...
form.addEventListener('submit', function(event) {
    ...
    const PersonalSpendingTotal = totalField.value;
    window.location.href = `SavingsDebt.html?income=${income}&expenses=${expenses}&personal=${PersonalSpendingTotal}`;
    });
